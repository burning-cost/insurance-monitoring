...
# Verify MonitoringTracker is accessible via lazy import
# (mlflow itself isn't installed — __getattr__ should find the class)
# We import directly from the submodule to avoid triggering mlflow import
from insurance_monitoring.mlflow_tracker import MonitoringTracker, _result_to_dict, _extract_scalar_metrics
print("MonitoringTracker importable (mlflow_tracker module loads without mlflow installed)")
