"""
Run insurance-monitoring v0.4.0 test suite on Databricks serverless compute.
Includes drift_attribution tests (TRIPODD).
"""
...
run = w.jobs.submit(
    run_name="insurance-monitoring-tests-v0.4.0",
    tasks=[
        jobs.SubmitTask(
            task_key="run_tests",
