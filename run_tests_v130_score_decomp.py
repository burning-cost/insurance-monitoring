"""
Run insurance-monitoring v1.2.0 test suite on Databricks serverless compute.
New in v1.2.0: ScoreDecompositionTest (arXiv:2603.04275, Dimitriadis & Puke 2026).
"""
...
run = w.jobs.submit(
    run_name="insurance-monitoring-tests-v1.2.0-score-decomp",
    tasks=[
        jobs.SubmitTask(
            task_key="run_tests",
